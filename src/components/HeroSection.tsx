    ...
    <div className="text-center py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
        ...
        <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
          <Link href="" onClick={async()=>{await signIn("google")}} className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
            Get Started
          </Link>
        </div>
      </div>
